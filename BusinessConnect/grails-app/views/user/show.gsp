            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.membershipLevel.label" default="Membership Level" /></td>
                            <td valign="top" class="value"><g:link controller="membershipLevel" action="show" id="${userInstance?.membershipLevel?.id}">${userInstance?.membershipLevel?.name?.encodeAsHTML()}</g:link></td>
                        </tr>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.entries.label" default="Entries" /></td>
