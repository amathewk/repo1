                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'membershipLevel', 'errors')}">
                                    <g:select name="membershipLevel.id" from="${app.businessConnect.MembershipLevel.list()}" optionKey="id" optionValue="name" value="${userInstance?.membershipLevel?.id}" noSelection="['null': '']" />
                                </td>
                            </tr>
