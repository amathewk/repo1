<%@ page import="app.businessConnect.User" %>
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="membershipLevel"><g:message code="user.membershipLevel.label" default="Membership Level" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'membershipLevel', 'errors')}">
                                    <g:select name="membershipLevel.id" from="${app.businessConnect.MembershipLevel.list()}" optionValue="name" optionKey="id" value="${userInstance?.membershipLevel?.id}" noSelection="['null': '']" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="entries"><g:message code="user.entries.label" default="Entries" /></label>
                                </td>
								...
								<g:link controller="entry" action="create" params="['user.id': userInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'entry.label', default: 'Entry')])}</g:link>
								 --%>
								<g:link controller="entry" action="list" params="['memberId': userInstance?.id]">view</g:link>
