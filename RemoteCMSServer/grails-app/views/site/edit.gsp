                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="domain"><g:message code="site.domain.label" default="Domain" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: siteInstance, field: 'domain', 'errors')}">
                                    <g:textField name="domain" value="${siteInstance?.domain}" />
                                </td>
                            </tr>
